...
export const BADGE_TEXT_FALLBACK: Record<string, string> = {
  badgeActivityFirstBrew: 'First Brew',
  badgeActivityFirstBrewDesc: 'Brew your first cup of tea.',
  badgeActivitySteadyHand: 'Steady Hand',
  badgeActivitySteadyHandDesc: 'Brew 10 cups of tea.',
  badgeActivityBrewingRegular: 'Brewing Regular',
  badgeActivityBrewingRegularDesc: 'Brew 50 cups of tea.',
  badgeActivityMasterBrewer: 'Master Brewer',
  badgeActivityMasterBrewerDesc: 'Brew 100 cups of tea.',

  badgeExplorerTeaNovice: 'Tea Novice',
  badgeExplorerTeaNoviceDesc: 'Try 3 different tea types.',
  badgeExplorerTeaTraveler: 'Tea Traveler',
  badgeExplorerTeaTravelerDesc: 'Try 6 different tea types.',
  badgeExplorerTeaConnoisseur: 'Tea Connoisseur',
  badgeExplorerTeaConnoisseurDesc: 'Try all 10 tea types.',
  badgeExplorerTempScout: 'Temp Scout',
  badgeExplorerTempScoutDesc: 'Brew at 5 different temperatures.',
  badgeExplorerTempNomad: 'Temp Nomad',
  badgeExplorerTempNomadDesc: 'Brew at 10 different temperatures.',
  badgeExplorerVesselCurator: 'Vessel Curator',
  badgeExplorerVesselCuratorDesc: 'Use 3 different vessels.',
  badgeExplorerVesselCollector: 'Vessel Collector',
  badgeExplorerVesselCollectorDesc: 'Use all 8 vessels.',

  badgePrecisionPerfectCup: 'Perfect Cup',
  badgePrecisionPerfectCupDesc: 'Log 5 brews rated 5 stars.',
  badgePrecisionFlawlessJudge: 'Flawless Judge',
  badgePrecisionFlawlessJudgeDesc: 'Log 20 brews rated 5 stars.',
  badgePrecisionBalancedArtisan: 'Balanced Artisan',
  badgePrecisionBalancedArtisanDesc: 'Achieve balance score 0.85+ in 10 brews.',
  badgePrecisionHarmonyMaster: 'Harmony Master',
  badgePrecisionHarmonyMasterDesc: 'Achieve balance score 0.90+ in 25 brews.',

  badgeStreakConsistentSipper: 'Consistent Sipper',
  badgeStreakConsistentSipperDesc: 'Brew on 3 consecutive days.',
  badgeStreakWeekWarrior: 'Week Warrior',
  badgeStreakWeekWarriorDesc: 'Brew on 7 consecutive days.',
  badgeStreakMonthlyDevotee: 'Monthly Devotee',
  badgeStreakMonthlyDevoteeDesc: 'Brew on 30 consecutive days.',

  badgeArchetypeZephyr: 'Zephyr',
  badgeArchetypeZephyrDesc: 'A light touch — dominant green tea style.',
  badgeArchetypeGoldenDrift: 'Golden Drift',
  badgeArchetypeGoldenDriftDesc: 'Bold and warm — dominant black or oolong style.',
  badgeArchetypeObsidian: 'Obsidian',
  badgeArchetypeObsidianDesc: 'Deep and dark — dominant pu-erh or Tibetan style.',
  badgeArchetypeBlossom: 'Blossom',
  badgeArchetypeBlossomDesc: 'Delicate and floral — dominant white or yellow style.',
  badgeArchetypeNova: 'Nova',
  badgeArchetypeNovaDesc: 'Restlessly experimental — no single style dominates.',
};
